<?php
    if(isset($_POST)){
        ...
        if($name == "" || $type == "" || $brand == "" || $price =="" || $price_sale =="" || $quantity == "" || $description=="" || $detail_des =="" || $file == ""){
            ...
            if(!is_numeric($price) || !is_numeric($price_sale)){
                ...
                $sql = "insert into sanpham (name, type, brand, image, price, price_sale, quantity, description, detail_des, is_hot) values('$name', '$type', '$brand', '$file', '$price', '$price_sale', '$quantity', '$description', '$detail_des', 0)";
