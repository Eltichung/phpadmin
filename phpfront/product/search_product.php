...
<body>
   ...
   <h3 style="color:cadetblue; margin:20px 30px;">Kết quả hiển thị tìm kiếm : <?php echo $_GET['search']?></h3> <br>
    <div class="content3-list">
                <?php foreach($result as $product=>$value){ ?>
                    <div class="content3-item" style="width:284px;box-sizing: border-box;">
                        <a href="./product/details_product.php?id_pro=<?php  echo $value['id'] ?>"><img style="width:264;height:264px;" src="../../img/<?php  echo $value['avatar'] ?>" alt=""></a>
